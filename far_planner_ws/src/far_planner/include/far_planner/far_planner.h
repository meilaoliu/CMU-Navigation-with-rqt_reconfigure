...
#include <far_planner/far_planner_nodeConfig.h>
...
public:
    ...
    void dynamicReconfigureCallback(far_planner::far_planner_nodeConfig &config, uint32_t level);
    void Init(); // ROS initialization
    void Loop(); // Main Loop Function

private:

    dynamic_reconfigure::Server<far_planner::far_planner_nodeConfig> dynamic_server_;
    far_planner::far_planner_nodeConfig dynamic_config_;
